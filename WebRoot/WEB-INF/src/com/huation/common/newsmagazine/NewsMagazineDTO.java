...
public class NewsMagazineDTO {
	...
	public String getNewsFileNm() {
		return NewsFileNm;
	}
	public void setNewsFileNm(String newsFileNm) {
		NewsFileNm = newsFileNm;
	}
	...
	protected String NewsFile; // 파일경로
	protected String NewsFileNm; // 파일명
