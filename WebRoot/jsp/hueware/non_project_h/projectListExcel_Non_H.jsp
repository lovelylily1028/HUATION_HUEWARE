...
<%
	...
	response.setHeader("Content-Disposition", "attachment; filename=projectExcel_Non_Hansol.xls");
...
<title>비정기점검 사이트 정보 리스트(한솔)</title>
</head>
...
<table width="820" cellspacing="0" cellpadding="0" border="1" style="margin:30 0 0 0;">
	<tr>
		<td width="100%">
		<div align="left"><strong><font size=6>한솔인티큐브 유지보수 정기점검 내역</font></strong><div align="right"><%=curDate %></div></div>
		...
		<table width="100%" cellpadding=0 cellspacing=0 border="1" style="border-collapse:collapse;">
			<tr height="25" bgcolor="#F8F9FA" >
                 ...
                 <td align="center"><strong>특이사항</strong></td>
			</tr>
		<!-- :: loop :: -->
		<!--리스트---------------->
		<%
