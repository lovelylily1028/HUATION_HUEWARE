...
<!-- //header -->
	...
	<div id="container">
		<div id="content">
			...
			<h3><span>L</span>astest News</h3><!-- 타이틀 앞글자는 <span></span>으로 감싸기 -->
			<div class="con">
				<!-- 컨텐츠 상단 영역 -->
				...
				<!-- 리스트 -->
				<table class="tbl_type tbl_type_list" summary="Lastest News리스트(No., 제목, 작성자, 등록일)">
					<colgroup>
						<col width="5%" />
						<col width="*" />
						<col width="8%" />
     ...
     <tbody>   
		...
		%>
        <tr>
          <td colspan="660" align="center">게시물이 없습니다.</td>
        </tr>
        <% 
		}
		%>
