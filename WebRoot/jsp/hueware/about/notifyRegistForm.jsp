...
<!-- //header -->
	...
	<div id="container">
		<div id="content">
			...
			<h3><span>공</span>지사항등록</h3><!-- 타이틀 앞글자는 <span></span>으로 감싸기 -->
			<div class="con">
				<!-- 컨텐츠 상단 영역 -->
				...
				<!-- //컨텐츠 상단 영역 -->
				<!-- 등록 -->
			    <form name="notifyRegist" method="post" action="<%= request.getContextPath()%>/B_About.do?cmd=notifyRegist">
				...
				<fieldset>
					...
					<table class="tbl_type" summary="공지사항등록(제목, 공지내용)">
						<colgroup>
							<col width="20%" />
							<col width="*" />
						</colgroup>
						...
						<tr>
							...
							<td><textarea id="" name="contents" title="공지내용" style="width:916px;height:248px;"></textarea></td>
						</tr>
						</tbody>
					</table>
				</fieldset>
