...
<%
	...
	response.setHeader("Content-Disposition", "attachment; filename=hueBookList.xls");
...
<table width="820" cellspacing="0" cellpadding="0" border="1" style="margin:30 0 0 0;">
	<tr>
		<td width="100%">
		<div ><strong><font size=6>HUEBOOK 목록 내역 </font></strong><div align="right"><%=curDate %></div></div>
							
		<table width="100%" cellpadding=0 cellspacing=0 border="1" style="border-collapse:collapse;">
			<tr height="25" bgcolor="#F8F9FA" >
                 <td align="center"><strong>관리번호</strong></td>
                 <td align="center"><strong>분야</strong></td>
                 ...
                 <td align="center"><strong>신청일자</strong></td>
                 <td align="center"><strong>결재자</strong></td>
		...
		%>
		 ...
		 <tr bgcolor="#FFFFFF" height="23">
		  <td align="center"><%=ds.getString("hueBookCode") %></td>
		  <td align="center"><%=ds.getString("branchCodeNm") %></td>
          ...
          <td align="center"><%=ds.getString("requestDate") %></td>
          <td align="center"><%=ds.getString("approvalName") %></td>
		...
		%>
			<tr align=center valign=top>
				<td colspan="6" align="center" class="td5">게시물이 없습니다.</td>
			</tr>
		<%
			}
		%>
