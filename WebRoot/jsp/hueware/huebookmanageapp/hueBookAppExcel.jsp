...
<%
	...
	response.setHeader("Content-Disposition", "attachment; filename=hueBookAppList.xls");
...
<table width="820" cellspacing="0" cellpadding="0" border="1" style="margin:30 0 0 0;">
	<tr>
		<td width="100%">
		<div ><strong><font size=6>HUEBOOK 도서결재 내역 </font></strong><div align="right"><%=curDate %></div></div>
		...
		<table width="100%" cellpadding=0 cellspacing=0 border="1" style="border-collapse:collapse;">
			<tr height="25" bgcolor="#F8F9FA" >
                 ...
                 <td align="center"><strong>신청일시</strong></td>
			</tr>
		<!-- :: loop :: -->
		<!--리스트---------------->
		<%
		...
		%>
          ...
          <td align="center"><%=ds.getString("createDate") %></td>
			</tr>
		<!-- :: loop :: -->
		<%
			i++;
