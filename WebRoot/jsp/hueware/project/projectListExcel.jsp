...
<%
	...
	if ("P".equals(listType)) {
		...
		response.setHeader("Content-Disposition", "attachment; fileName=project_All.xls");
	}
...
<table width="820" cellspacing="0" cellpadding="0" border="1" style="margin:30 0 0 0;">
	<tr>
		...
		<div >
			...
			<div align="right">
				<%=pjDTO.getFrDate() %>~<%=pjDTO.getToDate() %>
			</div>
		</div>
		...
		<table width="100%" cellpadding=0 cellspacing=0 border="1" style="border-collapse:collapse;">
			<tr height="25" bgcolor="#F8F9FA" >
                 ...
                 <td align="center"><strong>대상월</strong></td>
                 <td align="center"><strong>담당자</strong></td>
                 <td align="center"><strong>고객사</br>담당자</strong></td>
                 <td align="center"><strong>수행장소</strong></td>
                 <td align="center"><strong>수행내용</strong></td>
                 <td align="center"><strong>첨부파일명</strong></td>
			</tr>
		<!-- :: loop :: -->
		<!--리스트---------------->
		<%
