...
<script type="text/javascript">
	...
	function goExcel() {  
		 ...
		 formObj.submit();
		 formObj.action = "<%=request.getContextPath()%>/B_Project.do?cmd=projectPageListAll";	
	}
//-->
</script>
</head>
...
<!-- title -->
<div class="content_navi">프로젝트지원 &gt; 정기점검(종합)</div>
<h3><span>정</span>기점검(종합)</h3>
<!-- //title -->
...
%>
  ...
  <form method="post" name="projectPageListForm" action="<%=request.getContextPath()%>/B_Project.do?cmd=projectPageListAll" class="search">
...
<%= comDao.getMenuAuth(menulist,"27") %>