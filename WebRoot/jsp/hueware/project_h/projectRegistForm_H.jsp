...
function inputCheckSpecial(){
	...
	function cancle(){
		...
		var frm = document.projectRegist;
		frm.action='<%= request.getContextPath()%>/B_Project_H.do?cmd=projectPageList_H';
		frm.submit();
...
<!-- //컨텐츠 상단 영역 -->
    ...
    <form name="projectRegist" method="post" action="<%= request.getContextPath()%>/B_Project_H.do?cmd=projectRegist_H" enctype="multipart/form-data">
     ...
     <input type = "hidden" name = "pDay5" value=""/>
	  ...
	  <fieldset>
	  <legend>정기점검등록(한솔팩스)</legend>
      <table class="tbl_type" summary="정기점검등록(한솔팩스)(고객사, 시작일자, 종료일자, 대상월, 작성자, 담당자, 고객사담당자, 수행장소, 수행내용, 특이사항, 정기점검보고서)">
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
          ...
          <td><input type="text" name="CustChargeNm" value="" onkeyup="inputCheckSpecial()" class="text" title="고객사담당자" style="width:200px;" maxlength="10"  /></td>
        </tr>
         <tr>
