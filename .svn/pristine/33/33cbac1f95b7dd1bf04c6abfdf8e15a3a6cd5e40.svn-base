...
/**
 * 占쎄쑴猷놅옙占쎈뭄占쎈끏�륅옙醫롫짗占쎌닂彛뽳쭗�낅빐�좎뜦紐울옙�몄쒜占쎈맩�뺧옙醫롫짗占쎌늸占쏙쭚節뚯�占쎌쥙�⑵짆�낆삕占쏙옙�용쐻�좑옙*/
  ...
  // private java.lang.String BaroService_TISoap_address = "http://testws.baroservice.com/TI.asmx";
