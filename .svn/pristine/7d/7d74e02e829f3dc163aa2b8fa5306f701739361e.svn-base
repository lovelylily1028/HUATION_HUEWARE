...
<form name="phothFrm"  method="post" action="<%= request.getContextPath()%>/B_User.do?cmd=photoUpload"   enctype="multipart/form-data">
		<%
			if(fileNm.equals("")){
		%>
...
<script>
 parent.UserRegist.photo.value='<%=fileNm%>';
</script>