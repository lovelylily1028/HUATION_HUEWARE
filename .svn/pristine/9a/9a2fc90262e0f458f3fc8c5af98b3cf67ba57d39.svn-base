...
<div id="wrap">
						...
						<div id="panel_form">
							<div id="panel_InvoiceForm">
								...
								<table cellspacing="0" border="1" summary="전자세금계산서" class="tbl_type3">
									...
									<!-- //ie7을 위한 빈태그(지우지 마세요) -->
									<tr class="hd_bg">
										<th colspan="10" rowspan="2" class="hd_bdR"><span id="FormTitleName">전자세금계산서 취소발행</span><br><br>(기재사항 착오.정정)</th>
										...
										<tr>
											<th colspan="3">비고1</th>
											<td colspan="14"><input type="text" name="Remark11" id="" class="in_txt_off" readOnly value="당초 승인번호 (<%=invoiceDto.getApprove_no()%>)" style="width:99.1%;*width:99%;" maxlength="150" tabindex="26"></td>
											<td>&nbsp;</td>
										</tr>
										<tr>
	...
	<!-- ////////////////////////////////////////////중간//////////////////////////////////////////// -->
					...
					<form name="baroInvoiceRegist" method="post"   action="<%= request.getContextPath()%>/B_BaroInvoice.do?cmd=baroInvoiceModifyRegist" >
						...
						<div id="panel_form">
							<div id="panel_InvoiceForm">
								<p class="title_sub3">- 새로 작성하는 전자세금계산서</p>
								<table cellspacing="0" border="1" summary="전자세금계산서" class="tbl_type3">
									<caption>전자세금계산서</caption>
									<colgroup>
										<col width="3%" />
									...
									<!-- //ie7을 위한 빈태그(지우지 마세요) -->
									<tr class="hd_bg">
										<th colspan="10" rowspan="2" class="hd_bdR"><span id="FormTitleName">전자세금계산서</span><br><br>(기재사항 착오.정정)</th>
										<th colspan="2" rowspan="2">공급자<br>(보관용)</th>
										<th colspan="2">책번호</th>
										<td colspan="4">
											<input type="text" name="Kwon" id="" class="in_txt" value="" style="width:33%;" maxlength="4" tabindex="1">권&nbsp;
											<input type="text" name="Ho" id="" class="in_txt" value="" style="width:33%;" maxlength="4" tabindex="2">호
										</td>
									</tr>
									<tr class="hd_bg">
										<th colspan="2">일련번호</th>
									...
									<tr>
										<th colspan="2">상호</th>
										<td colspan="3"><textarea name="InvoicerCorpName" id="" class="in_txt" style="width:96.5%;*width:95.5%;" maxlength="70" tabindex="6">주식회사 휴에이션</textarea></td>
										<th>성명</th>
										<td colspan="2"><textarea name="InvoicerCEOName" id="" class="in_txt" style="width:91%;*width:89%;" maxlength="30" tabindex="7">김준민</textarea></td>
										<th>상호 *</th>
									...
									<tr>
										<th colspan="2">사업장주소</th>
										<td colspan="6"><textarea name="InvoicerAddr" id="" class="in_txt" style="width:98%;height:50px;*width:97%;" maxlength="150" tabindex="8">서울특별시 금천구 디지털로9길 32(가산동,갑을그레이트밸리B동 602호)</textarea></td>
										<th>사업장주소 *</th>
									...
									<tr>
										<th colspan="2">업태</th>
										<td colspan="2"><textarea name="InvoicerBizType" id="" class="in_txt" style="width:95%;*width:94%;" maxlength="40" tabindex="9">서비스,도소매</textarea></td>
										<th>종목</th>
										<td colspan="3"><textarea name="InvoicerBizClass" id="" class="in_txt" style="width:94.5%;*width:92.5%;" maxlength="40" tabindex="10">소프트웨어개발외,컴퓨터 및 주변장치,통신 재판매업</textarea></td>
										<th>업태 *</th>
									...
									<tr>
										<th colspan="2">담당자</th>
										<td colspan="2"><input type="text" name="InvoicerContactName1" id="" class="in_txt" value="김경화" style="width:95%;*width:94%;" maxlength="30" tabindex="11"></td>
										<th>연락처</th>
									...
									<tr>
										<td colspan="3">
											<input type = "hidden" name="WriteDT" id = "WriteDT"/><input type="text" name="WriteDT1" maxlength="4" id="" class="in_txt" IconYN="0" value="<%=Integer.toString(cal.get(Calendar.YEAR))%>" style="width:24px;" maxlength="10" tabindex="25">년
											<input type="text" name="WriteDT2" maxlength="2" class="in_txt" value="<%=df.format(cal.get(Calendar.MONTH)+1) %>" style="width:12px;"/>월
											<input type="text" name="WriteDT3" maxlength="2" class="in_txt" value="<%=df.format(cal.get(Calendar.DATE))%>" onkeyup="javascript:day_check();" style="width:12px;"/>일
										</td>
									...
									<tr>
										<th colspan="3">비고1</th>
										<td colspan="14"><input type="text" name="Remark1" id="" class="in_txt" value="당초 승인번호 (<%=invoiceDto.getApprove_no()%>)" style="width:99.1%;*width:99%;" maxlength="150" tabindex="26"></td>
										<td>&nbsp;</td>
									</tr>
									<tr>
										<th colspan="3">작성방법</th>
										<td colspan="15">
											<input type="radio" name="WriteType" id="WriteType4" value="4" checked onclick="changeWriteType(4);"><label class="for" for="WriteType4"> 직접입력</label>
										</td>
									</tr>
									<tr>
										<th>월<input type="hidden" name="DetailJSON" id="" value="" ></th>
								...
								<p class="title_sub"><img src="<%= request.getContextPath()%>/images/p_baroInvoice2.gif" alt="세금계산서 부가정보" /><span class="noti">* 표시는 필수 입력 항목입니다.</span></p>
								<table cellspacing="0" border="1" summary="세금계산서 발행" class="tbl_type2">
									...
									<tr>
										<th>견적서발행번호<span class="noti">*</span></th>
										<td><input type="text" name="p_public_no" class="in_txt_off" value=""  style="width:80px" readOnly><a href="#" class="btn3"></a></td>
									</tr>
									<tr>
										<th>전자세금계산서<br />발행기관</th>
										<td><input type="text" name="public_org" class="in_txt" value="바로빌" style="ime-mode:active;width:150px" maxlength="25"></td>
									</tr>
									<tr>
										<th>입금예상일자<span class="noti">*</span></th>
										<td>
											<%/*
											*달력 만드는 부분
											*/
									...
									<tr>
										<th>입금예상계좌<span class="noti">*</span></th>
										<td>
											<%
									...
									<tr>
										<th>입금금액</th>
										<td><input type="hidden" name="deposit_amt" class="in_txt"  style="width:80px" value="0" ><input type="text" name="deposit_amt_view" class="in_txt" style="width:135px;text-align:right;font-weight:bold;color:#06F;" maxlength="18"  onKeyUp = "saleCntCal('baroInvoiceRegist.deposit_amt')" value="0">원<br /><font color="red">*<u>입금금액 입력 시 입금일자는 필수 입력 항목입니다.</u>*</font></td>
									</tr>
									<tr>
										<th>입금일자</th>
										<td>
									...
									<tr>
										<th>참고사항</th>
										<td><textarea name="reference" class="in_txt" style="ime-mode:active;width:98.5%; height:40px;padding:5px" dispName="참고사항 " onKeyUp="js_Str_ChkSub('500', this)"></textarea></td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div id="panel_button" class="btn2">
							<a href="#"><img src="<%= request.getContextPath()%>/images/btn_issue3.gif" value="발행" onclick="javascript:registInvoice();" alt="발행" title="발행" /></a>
							<a href="#"><img src="<%=request.getContextPath()%>/images/btn_cancel2.gif" value="취소" onclick="javascript:cancle();" alt="취소" title="취소" /></a>
						</div>
						<!-- //button -->
					</form>
				</div>
