...
function addRow2(){
	...
	rowString +="<td colspan=\"1\" class=\"a_c\"><input type=\"button\" value=\"행제거\" id =\"bt\"  style=\"cursor:hand;\" onclick=\"javascript:removeRow(this);\"/></td>"; 
	rowString +="</tr>";
						...
						<div id="panel_form">
							<div id="panel_InvoiceForm">
								...
								<table cellspacing="0" border="1" summary="전자세금계산서" class="tbl_type3">
									...
									<!-- //ie7을 위한 빈태그(지우지 마세요) -->
									<tr class="hd_bg">
										<th colspan="10" rowspan="2" class="hd_bdR"><span id="FormTitleName">전자세금계산서 취소발행</span><br><br>(착오에 의한 이중발급)</th>
