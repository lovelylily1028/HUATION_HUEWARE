...
<%
	...
	response.setHeader("Content-Disposition", "attachment; fileName=ProjectCodeManage.xls");
...
<table width="820" cellspacing="0" cellpadding="0" border="1" style="margin:30 0 0 0;">
	<tr>
		<td width="100%">
		<div ><strong><font size=6>Huation 프로젝트 조회 내역 </font></strong><div align="right"></div></div>
