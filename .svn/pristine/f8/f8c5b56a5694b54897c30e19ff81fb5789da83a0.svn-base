...
<script type="text/javascript">
	...
	function goDetail(pjseq){
		 ...
		 formObj.action = "<%= request.getContextPath()%>/B_ProjectCodeManage.do?cmd=projectCodeMgSearchView";
	...
	//Excel Down
	function goExcel() {  
		 formObj.action = "<%=request.getContextPath()%>/B_ProjectCodeManage.do?cmd=projectCodeMgPageList_Search_Excel";	
		 formObj.submit();
		 formObj.action = "<%=request.getContextPath()%>/B_ProjectCodeManage.do?cmd=projectCodeMgPageList_Search";	
	}
//-->
</script>
</head>
<body onload="init_proiectcodeMg();">
<div id="wrap">
...
<!-- //header -->
	...
	<div id="container">
		<div id="content">
			...
			<h3><span>프</span>로젝트조회</h3><!-- 타이틀 앞글자는 <span></span>으로 감싸기 -->
			<div class="con">
				<!-- 컨텐츠 상단 영역 -->
			  ...
			  <form method="post" name="projectMgPageListSearchForm" class="search" action="<%=request.getContextPath()%>/B_ProjectCodeManage.do?cmd=projectCodeMgPageList_Search">
				...
				<!-- //컨텐츠 상단 영역 -->        
 				...
 				<!-- 리스트 -->
				<table class="tbl_type tbl_type_list" summary="프로젝트조회리스트(No., 진행, 검수증빙문서, 최종산출물, 프로젝트코드, 프로젝트구분, 프로젝트명, 고객사, 발주사, 담당영업, 담당PM, 프로젝트시작일, 프로젝트종료일, 프로젝트진행기간, 등록자, 등록일시)">
					<colgroup>
						<col width="3%" />
						<col width="4%" />
						<col width="4%" />
