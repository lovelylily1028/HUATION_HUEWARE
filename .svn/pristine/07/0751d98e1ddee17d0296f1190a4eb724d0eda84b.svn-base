...
function goSave(){
	var frm = document.ContractRegistManageViewForm; 
...
if(confirm("수정 하시겠습니까?")){
	frm.action='<%=request.getContextPath()%>/B_ContractManage.do?cmd=contractRegistMgEdit'
	...
	//날짜 입력 벨류데이션 체크 시작.(계약일자)
	  ...
	  if(chk == true){
	  var frm = document.ContractRegistManageViewForm; 	 //폼셋팅
	...
	*/
	...
	//달력 텍스트입력창-1(계약일자)
	  function datepickerInputText_1(){
		  var frm = document.ContractRegistManageViewForm;	//폼생성
	...
	function popPublicNo(){
		var a = window.open("<%= request.getContextPath()%>/B_Common.do?cmd=searchPublicNoConY_Cm&sForm=ContractRegistManageViewForm&contractGb=Y","","width=850,height=683,left=20,top=20,toolbar=no, location=no, directories=no, menubar=no, resizable=yes, scrollbars=no, status=no");
	}
//-->
</SCRIPT>
</head>
...
<div id="wrap">
	...
	<div id="container">
		<div id="content">
			...
			<h3><span>계</span>약등록상세정보</h3><!-- 타이틀 앞글자는 <span></span>으로 감싸기 -->
			<div class="con" id="excelBody">
				...
				<div class="con_sub">
					...
					<!-- //컨텐츠 상단 영역 -->
					<!-- 등록 -->
					<form name="ContractRegistManageViewForm" method="post" action="<%= request.getContextPath()%>/B_ContractManage.do?cmd=contractRegistMgEdit" enctype="multipart/form-data">
					...
					<fieldset>
						...
						<table class="tbl_type" summary="계약관리상세정보(견적번호, 계약명, 계약일자, 계약서, 발주일자, 발주서, 계약종료여부, 발주사(업체명), 업체담당자, 업체담당자연락처, 업체담당자핸드폰번호)">
							...
							<tr>
								...
								<td><input type="text" name="Public_No" class="text dis" title="견적번호" style="width:200px;" readonly="readonly" value="<%=cmDto.getPublic_No() %>" onClick="javascript:popPublicNo();" />
							</tr>
							<tr>
								...
								<td><input type="text" name="ContractName" class="text dis" title="계약명" style="width:500px;" maxlength="250" readonly="readonly" value="<%=cmDto.getContractName()%>" /></td>
							</tr>
							<tr>
								...
								<td>
									<ul class="listD">
										<li class="first" id="ContractDate_P_None"><label for="ConChk">계약일자를 입력하시려면 체크 하세요.</label> <input type="checkbox" id="ConChk" name="ConChk" value="" readonly="readonly" class="check md0" title="계약일자입력선택" /></li>
										<!-- 체크박스 선택 -->
										<li id="ContractDate_P_tag">Date&nbsp;&nbsp;<span class="ico_calendar"><input type="text" size="10" name="ContractDate" id="calendarData1" maxlength="8" readonly="readonly" value="<%=cmDto.getContractDate()%>" class="text dis" title="계약일자입력" style="width:100px;" /></span></li>
										<!-- //체크박스 선택 -->
									</ul>
								</td>
							</tr>
							<tr>
								...
								<td><input type="hidden" name="ContractFileNm" value="<%=cmDto.getContractFileNm()%>" /><div class="fileUp"><input type="text" class="text dis" id="file1" title="계약서" style="width:566px;" value="<%=cmDto.getContractFile() %>" readonly="readonly" /></td>
							</tr>
							<tr>
								...
								<td>
									<ul class="listD">
										<li class="first" id="PurchaseDate_P_None"><label for="PurChk">발주일자를 입력하시려면 체크 하세요.</label> <input type="checkbox" id="PurChk" name="PurChk" value="" readonly="readonly" class="check md0" title="발주일자입력선택" /></li>
										<!-- 체크박스 선택 -->
										<li id="PurchaseDate_P_tag">Date&nbsp;&nbsp;<span class="ico_calendar"><input type="text" size="10" name="PurchaseDate" id="calendarData2" maxlength="8" readonly="readonly" value="<%=cmDto.getPurchaseDate()%>" class="text dis" title="발주일자입력" style="width:100px;" /></span></li>
										<!-- //체크박스 선택 -->
									</ul>
								</td>
							</tr>
							<tr>
								...
								<td><input type="hidden" name="PurchaseOrderFileNm" value="<%=cmDto.getPurchaseOrderFileNm()%>" /><input type="hidden" name="p_PurchaseOrderFile" value="<%=cmDto.getPurchaseOrderFile()%>" /><div class="fileUp"><input type="text" class="text dis" id="file2" title="발주서" style="width:566px;" readonly="readonly" value="<%=cmDto.getPurchaseOrderFile()%>" /></td>
							</tr>
							<%
								String achecked = "";
								String bchecked = "";
							...
							<tr id="cmStChk">
								...
								<td> <input type="radio" name="cmChk" id="cmChk2" class="radio md0" title="조기종료" readonly="readonly" value="2" <%=bchecked %>></input><label for="cmChk2">조기종료</label><input type="radio" name="cmChk" id="cmChk3" class="radio" title="계약종료" readonly="readonly" value="3" <%=cchecked %>></input><label for="cmChk3">계약종료</label><input type="radio" name="cmChk" id="cmChk1" class="radio" title="진행중" readonly="readonly" value="1" <%=achecked %>></input><label for="cmChk1">진행중</label><input type="hidden" name="ContractStatus" value="<%=cmDto.getContractStatus() %>" /></td>
							</tr>
							<tr id="CmDate_tr"><!-- 계약종료여부에서 조기종료, 계약종료 선택 시 노출 -->
								...
								<td>Date&nbsp;&nbsp;<span class="ico_calendar"><input type="text" size="10" name="ContractEndDate" id="calendarData3" maxlength="8" readonly="readonly" value="<%=ContractEndDate%>" onkeyup="javascript:datepickerInputText_3();" class="text dis" title="종료일자입력" style="width:100px;" /></span><span class="guide_txt">&nbsp;&nbsp;* 텍스트 상자에 직접 일자 입력 할 경우 (예 : 2013-01-01) </span>
								<%--
							...
							<tr>
								...
								<td><input type="text" name="CustomerName" maxlength="10" class="text dis" title="업체담당자" style="width:200px;" readonly="readonly" value="<%=cmDto.getCustomerName()%>" /></td>
							</tr>
							<tr>
								<th><label for="">업체담당자연락처</label></th>
								<td><input type="text" name="CustomerTel" class="text dis" title="업체담당자연락처" style="width:200px;" readonly="readonly" value="<%=cmDto.getCustomerTel() %>" maxlength="13" onkeyup="format_phone(this);" /></td>
							</tr>
							<tr>
								<th><label for="">업체담당자핸드폰번호</label></th>
								<td><input type="text" name="CustomerMobile" class="text dis" title="업체담당자핸드폰번호" style="width:200px;" readonly="readonly" value="<%=cmDto.getCustomerMobile() %>" maxlength="13" onkeydown="MaskPhon(this);" onkeyup="MaskPhon(this);"></td>
							</tr>
							</tbody>
						</table>
					</fieldset>
