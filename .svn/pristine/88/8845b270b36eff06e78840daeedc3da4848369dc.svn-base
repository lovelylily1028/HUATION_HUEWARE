...
<!-- //header -->
	...
	<div id="container">
		<div id="content">
			<div class="content_navi">게시판 &gt; 경조사</div>
			<h3><span>경</span>조사상세정보</h3><!-- 타이틀 앞글자는 <span></span>으로 감싸기 -->
			<div class="con" id="excelBody">
				...
				<fieldset>
					<legend>경조사상세정보</legend>
					<table class="tbl_type" summary="경조사상세정보(게시자, 첨부파일, 제목, 내용)">
						...
						<tr>
							...
							<td><input type="text" id="" class="text dis" title="게시자" style="width:200px;" readOnly value="<%=feDto.getWriteUserName()%>"/></td><!-- input 비활성화 class="dis" 추가 -->
						</tr>
				    	...
				    	<tr>
							...
							<td><div class="fileUp"><input type="text" class="text" id="file1" title="첨부파일" style="width:561px;" value="<%=feDto.getEventFile() %>" /><a href="#link" class="btn_type03" value="찾아보기"><span>찾아보기</span></a><input type="file" name="EventFile" id="upload1" /></div><input type="hidden" name="p_EventFile" value="<%=feDto.getEventFile()%>"/><input type="hidden" name="EventFileNm" value="<%=feDto.getEventFileNm()%>"></input><span class="guide_txt">&nbsp;&nbsp;* 첨부가능 파일유형 : 모든 파일 / 첨부가능 용량 : 최대 500M</span></td><!-- input 비활성화 class="dis" 추가 -->
						</tr>
						
						<tr>
							<th><label for=""><span class="must_ico"><img src="<%= request.getContextPath()%>/images/common/must_icon_01.gif" alt="필수입력" /></span>제목</label></th>
							<td><input type="text" id="" name="Title" value="<%=feDto.getTitle() %>" class="text" title="제목" style="width:916px;" maxlength="100"/></td><!-- input 비활성화 class="dis" 추가 -->
						</tr>
						
						<tr>
							<th><label for=""><span class="must_ico"><img src="<%= request.getContextPath()%>/images/common/must_icon_01.gif" alt="필수입력" /></span>내용</label></th>
							<td><textarea id="" name="Contents" title="내용" style="width:916px;height:248px;" onKeyUp="js_Str_ChkSub('1000', this)"><%=feDto.getContents()%></textarea></td><!-- input 비활성화 class="dis" 추가 -->
						</tr>	 
    					...
    					<tr>
							<th><label for="">첨부파일</label></th>
							<td><div class="fileUp"><input type="text" class="text dis" id="file1" title="첨부파일" style="width:561px;" value="<%=feDto.getEventFile() %>" readOnly /><a href="#link" class="btn_type03" value="찾아보기"><span>찾아보기</span></a><input type="file" name="EventFile" id="upload1" /></div><input type="hidden" name="p_EventFile" value="<%=feDto.getEventFile()%>"/><input type="hidden" name="EventFileNm" value="<%=feDto.getEventFileNm()%>"></input><span class="guide_txt">&nbsp;&nbsp;* 첨부가능 파일유형 : 모든 파일 / 첨부가능 용량 : 최대 500M</span></td><!-- input 비활성화 class="dis" 추가 -->
						</tr>
    					
						<tr>
							<th><label for=""><span class="must_ico"><img src="<%= request.getContextPath()%>/images/common/must_icon_01.gif" alt="필수입력" /></span>제목</label></th>
							<td><input type="text" id="" name="Title" value="<%=feDto.getTitle() %>" class="text dis" title="제목" style="width:916px;" maxlength="100" readonly="readonly"/></td><!-- input 비활성화 class="dis" 추가 -->
						</tr>
						
						<tr>
							<th><label for=""><span class="must_ico"><img src="<%= request.getContextPath()%>/images/common/must_icon_01.gif" alt="필수입력" /></span>내용</label></th>
							<td><textarea id="" name="Contents" title="내용" class="dis" style="width:916px;height:248px;" onKeyUp="js_Str_ChkSub('1000', this)" readonly="readonly"><%=feDto.getContents()%></textarea></td><!-- input 비활성화 class="dis" 추가 -->
						</tr>    					
