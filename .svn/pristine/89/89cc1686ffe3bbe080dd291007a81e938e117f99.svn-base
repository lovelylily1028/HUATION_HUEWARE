...
public class DocumentFileDTO {
	...
	public String getDocumentFileNm() {
		return DocumentFileNm;
	}
	public void setDocumentFileNm(String documentFileNm) {
		DocumentFileNm = documentFileNm;
	}
	...
	protected String DocumentFile; // 파일경로
	protected String DocumentFileNm; // 파일명
