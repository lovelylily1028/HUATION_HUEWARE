...
<%
	...
	response.setHeader("Content-Disposition", "attachment; fileName=ProjectCodeManage_Progress.xls");
...
<table width="820" cellspacing="0" cellpadding="0" border="1" style="margin:30 0 0 0;">
	<tr>
		<td width="100%">
		<div ><strong><font size=6>Huation 프로젝트 진행 내역 </font></strong><div align="right"></div></div>
		...
		<table width="100%" cellpadding=0 cellspacing=0 border="1" style="border-collapse:collapse;">
		 <tr height="25" bgcolor="#F8F9FA" >
          ...
          <th align="center"><strong>프로젝트 잔여일</strong></th>
