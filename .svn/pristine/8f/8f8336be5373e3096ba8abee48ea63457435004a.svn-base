...
<!--
	...
	function goSelect(id,nm){
		var userid=eval('opener.document.<%=sForm%>.user_id2');
		userid.value=id;
		var usernm=eval('opener.document.<%=sForm%>.user_nm2');
		usernm.value=nm;
...
<div id="wrapWp">
   <!-- header -->
	...
	<!-- 조회 -->
<form  method="post" name=searchform action = "<%= request.getContextPath()%>/B_Common.do?cmd=searchUser2" class="search">
